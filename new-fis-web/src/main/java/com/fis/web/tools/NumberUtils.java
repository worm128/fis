...
public abstract class NumberUtils {
	...
	public static String formatFileSize(long size){
		...
		if(size<base)//小于1k，直接返回
		{
			return size+"B";
		}
		if(size>=base&&size<base*1024)
		{
			return truncate(String.valueOf((double)size/base),2)+"KB";
		}
		base=base*1024;
		
		if(size>=base&&size<base*1024)
		{
			return truncate(String.valueOf((double)size/base),2)+"MB";
		}
		base=base*1024;
		
		if(size>=base&&size<base*1024)
		{
			return truncate(String.valueOf((double)size/base),2)+"GB";
		}
		base=base*1024;
		
		if(size>=base&&size<base*1024)
		{
			return truncate(String.valueOf((double)size/base),2)+"TB";
		}
		base=base*1024;
		
		return truncate(String.valueOf((double)size/base),2)+"PB";
